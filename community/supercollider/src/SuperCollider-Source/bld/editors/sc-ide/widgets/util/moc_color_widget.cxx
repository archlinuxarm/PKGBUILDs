...
static const char qt_meta_stringdata_ScIDE__ColorWidget[] = {
    "ScIDE::ColorWidget\0colorChanged(QColor)\0"
    "\0brushChanged(QBrush)\0colorPicked(QColor)\0"
    "clear()\0"
};
...
const QMetaObjectExtraData ScIDE::ColorWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject ScIDE::ColorWidget::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_ScIDE__ColorWidget,
      qt_meta_data_ScIDE__ColorWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &ScIDE::ColorWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ScIDE__ColorWidget))
